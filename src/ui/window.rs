use crate::{
    ...
    send_message,
    state::{
        get_action_menu_item, get_action_menu_query, get_current_prefix, get_error,
        get_initial_height, get_initial_max_height, get_initial_max_width, get_initial_min_height,
        get_initial_min_width, get_initial_placeholder, get_initial_width, get_last_query,
        get_prefix_provider, get_provider, get_query, get_theme, get_theme_grid_columns,
        is_actions_menu, is_connected, is_dmenu, is_dmenu_exit_after, is_dmenu_keep_open,
        is_emergency, is_grid, is_no_hints, is_service, set_action_menu_item,
        ...
        set_parameter_width, set_placeholder, set_provider, set_query, set_theme,
    },
